...
import de.timesnake.library.basic.util.player.User;
...
public abstract class Sender {
    ...
    public void sendPluginMessage(String message) {
        this.cmdSender.sendMessage(Server.getChat().getSenderPlugin(plugin) + message);
    }
    ...
    public String getSenderPlugin() {
        return Server.getChat().getSenderPlugin(this.plugin);
    }
